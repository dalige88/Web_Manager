...
namespace YL.Base.Extensions
{
    public static class TypeExtensions
    {
        ...
        /// <param name="result"></param>
        /// <returns></returns>
        public static bool TryConvertTo(this object value, Type destinationType, out object result)
        {
            try
            {
            ...
            where TModel : class
        {
            ...
            List<PropertyInfo> props = type.GetProperties(BindingFlags.Public | BindingFlags.Instance | BindingFlags.GetProperty).ToList();
            props.Foreach(r =>
            {
                if (r != null)
        ...
        public static T Clone<T>(this T obj)
        {
            ...
            if (obj != null)
            {
                ret = JsonConvert.DeserializeObject<T>(JsonConvert.SerializeObject(obj));
            }
            return ret;
        }
